...
public enum RegEx {
   ...
   // PHONE  ("\\(?([0-9]{3})\\)?([0-9]{3})?([0-9]{4})"), 
    ...
    EDUCATION ("\\b(?i)(Education(s?)|EDUCATION(S?)|Bachelor of Technology(s?)|BTECH(S?)|BTech(s?)|SSC(S?)|ssc(S?)|inter(S?)|intermediate(S?))\\b"),
    EXPERIENCE ("\\b(?i)Experience"),
    SKILLS ("\\b(?i)java|MicroServices|Spring IOC|Spring MVC |Spring Boot\\b"),
	...
	// SKILLS (" \\b(?i)java\\b |\\b(?i)MicroServices\\b | \\b(?i)Spring IOC\\b | \\b(?i)Spring MVC\\b | \\b(?i)Spring Boot\\b | \\b(?i)Spring\\b "),
	// EXPERIENCE ("\\b(?i)(Experience(s?)|EXPERIENCE(S?))|java(?)|JAVA(?)|JavaTechnologies(?) \\b"),
